...
vector<string> favs = {"Zelda", "Mario", "Metroid"};
    ...
    do {
        ...
        if(chapt == 4) {
                ...
                // create a cector of strings at the top of main()
                ...
                / use cin to find the name to remove.
                cout << "What name sjould we remove from favs?\n";
                string input;
                cin >> input;
                ...
                if(iter != favs.end()){
                    cout << "found it!\n";
                    // remove na element from vector
                    // at the place the iteration
                    favs.erase(iter);
                }
                else {
                    cout << I count not find the name in favs.\n";

}
                // use vec.erase(iter) to remove a name.
                if(find(favs.begin(), favs.end(), input) != favs.end() ) {
                cout<<found it!\n";
                find()
            }
